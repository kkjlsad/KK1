...
export async function readTextIfAccessible(filePath: string): Promise<string | undefined> {
  try {
...
export function resolveWithinHome(inputPath: string): string {
...
export function truncate(value: string, limit: number = MAX_OUTPUT_CHARS): string {
